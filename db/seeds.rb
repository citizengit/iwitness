...
p3 = Post.create(:title => 'Pigs Fly', :body => "I guess the cost of bacon will obviously go up too then", :imgurl => 'http://trekbikes.typepad.com/.a/6a00d83453a62f69e2016306582522970d-500wi', :address => "parramatta rd, stanmore", :rating_up => 22, :rating_down => 98)
